...
- CURRENT TASK: *Implement address translation and memory protection.*
- Stumble through processor init rom tests implementing features and fixing instruction bugs as tests fail. (this will only be marked DONE when all tests pass)
